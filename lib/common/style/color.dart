...
class AppColor {
  ...
  static const Color primaryLogoTextColor = Color(0xff0055b0);

  /// 主要背景颜色
  static const Color primaryBackground = Color.fromARGB(31, 0, 134, 211);
...
class AppColors {
  ...
  static const Color primaryBackground = Color.fromARGB(255, 177, 224, 236);
  ...
  /// primary color
  static const Color primaryElement = Color.fromARGB(255, 149, 202, 216);
